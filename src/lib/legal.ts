// Hosted legal pages (the web /legal/ set).
//
...
export const MEDICAL_DISCLAIMER_URL = `${LEGAL_BASE_URL}/aviso-medico.html`;
export const REFUNDS_URL = `${LEGAL_BASE_URL}/reembolsos.html`;
export const DATA_DELETION_URL = `${LEGAL_BASE_URL}/eliminar-datos.html`;
